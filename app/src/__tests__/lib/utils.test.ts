        ...
        positions: [
          {
            ...
            number: 1,
            shots: [
              { id: 'shot1', positionId: 'pos1', targetNumber: 1, result: 'hit', timestamp: new Date() },
              { id: 'shot2', positionId: 'pos1', targetNumber: 2, result: 'hit', timestamp: new Date() }
            ],
            score: 2,
            isComplete: true
          },
          {
            ...
            number: 2,
            shots: [
              { id: 'shot3', positionId: 'pos2', targetNumber: 1, result: 'miss', timestamp: new Date() },
              { id: 'shot4', positionId: 'pos2', targetNumber: 2, result: 'hit', timestamp: new Date() }
            ],
            score: 1,
            isComplete: true
          }
