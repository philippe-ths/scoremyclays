...
export default function ScoringPage() {
  ...
  const undoLastShot = () => {
    ...
    setScoring(prev => {
      ...
      if (prev.hits > 0) {
        newScoring.hits -= 1;
        newScoring.currentStandHits = Math.max(
          0,
          newScoring.currentStandHits - 1
        );
  ...
  const percentage =
    totalShots > 0 ? Math.round((scoring.hits / totalShots) * 100) : 0;
        ...
        <Card className='card-secondary p-4'>
          ...
          <div className='w-full bg-clay-surface rounded-full h-2'>
            <div
              ...
              style={{
                width: `${
                  ((scoring.currentStand - 1) / scoring.totalStands +
                    (scoring.currentPair - 1) /
                      (scoring.totalPairs * scoring.totalStands)) *
                  100
                }%`,
              }}
            />
