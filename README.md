...
An **offline-first mobile app** for clay pigeon shooting scoring and personal performance tracking. Built with React Native, Expo, and PowerSync.

## Documentation

| Document | Description |
|----------|-------------|
| [Overview](docs/overview.md) | What the app does, domain terminology, MVP scope |
| [Architecture](docs/architecture.md) | Tech stack, provider hierarchy, data flow, directory structure |
